//
//  AUInstrumentAudioUnit.m
//  AUInstrument
//
//  Created by Hallgrim Bratberg on 11/08/2021.
//

#import "AUInstrumentAudioUnit.h"
...
@interface AUInstrumentAudioUnit ()
...
@implementation AUInstrumentAudioUnit
...
- (instancetype)initWithComponentDescription:(AudioComponentDescription)componentDescription options:(AudioComponentInstantiationOptions)options error:(NSError **)outError {
	...
	_kernelAdapter = [[AUInstrumentDSPKernelAdapter alloc] init];
...
- (void)setupParameterCallbacks {
	...
	__block AUInstrumentDSPKernelAdapter * kernelAdapter = _kernelAdapter;
